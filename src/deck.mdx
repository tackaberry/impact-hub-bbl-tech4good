...
- philanthropy from tech billionaires
- examples of tech solving social challenges
...
- limited use of technology able to transform business models - business opportunities are wasted
...
- Benevity being the technology that is linking corporation to

- using tech to connect social sector orgs enterprise - take advantage
...
- gov't using modern practices to improve service delivery, citizens using tools to fill gaps in govt, communication, sharing expertise
- more open, and work collaboratively
- ottawa civic tech
- codeforcanada
- around the world - code for america, code for australia, taiwain, estonia
...
- engineers on boards
- adopt a tech company
- engage in programs with tech
